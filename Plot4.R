...
plot(subconjunto$Date_Time, subconjunto$Global_active_power, 
     type = "l",
     xlab = "", 
...
plot(subconjunto$Date_Time, subconjunto$Voltage, 
     type = "l",
     xlab = "datetime", 
     ylab = "Voltage")

with(subconjunto, plot(Date_Time, Global_reactive_power,type = "l",
                       xlab = "datetime" ))
